module.exports = function(Prefix, message, commandName, args, request, client) {
    if (message.channel.nsfw === true || message.guild === null) {
        ...
        request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&tags=-loli -asian -3d -photo_(medium) rating:explicit overwatch -loli&json=1`, function(error, response, body) {
...
module.exports.config = {
    description: "Gives you a overwatch image",
    usage: `overwatch`,
    aliases: [],
    type: "nsfw",
    optinal: ""
