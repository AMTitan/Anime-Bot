            ...
            .then(collected => {
                ...
                if (nsfw === true) {
                    if (message.channel.nsfw === true || message.guild === null) {
                        client.request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&limit=1000/index.php?page=dapi&s=post&q=index&tags=${client.banlist}${client.banlist}-loli -asian -3d -photo_(medium) ${types[3]} ${args.join(" ")} -loli&json=1`).then(res => res.text()).then(body => {
                            if (body.trim() !== "") {
                                ...
                                if (jsonParsed === "undefined") {
                                    const Embed = {
                                        ...
                                        description: `maybe do ` + "`" + `${client.Prefix}help` + "`" + ` or you can do ` + "`" + `${client.Prefix}search ${args.join(" ")}` + "`" + `? But if you really want this command you can ` + "`" + `${client.Prefix}improve ${commandName}` + "`",
                                        thumbnail: "",
                                        fields: [],
                                        image: {
                                            url: ""
                        ...
                        const Embed = {
                            ...
                            description: `maybe do ` + "`" + `${client.Prefix}help` + "`" + ` or you can do ` + "`" + `${client.Prefix}search ${args.join(" ")}` + "`" + `? But if you really want this command you can ` + "`" + `${client.Prefix}improve ${commandName} (what to improve)` + "`",
                            thumbnail: "",
                            fields: [],
                            image: {
                                url: "",
                    ...
                    if (message.channel.nsfw === true || message.guild === null) {
                        client.request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&limit=1000/index.php?page=dapi&s=post&q=index&tags=${client.banlist}${client.banlist}-loli -asian -3d -photo_(medium) ${types[2]} ${args.join(" ")}&json=1`).then(res => res.text()).then(body => {
                            if (body.trim() !== "") {
                                var shouldIReturn = false;
                                if (!body) {
                                    const Embed = {
                        ...
                        const Embed = {
                            ...
                            description: `maybe do ` + "`" + `${client.Prefix}help` + "`" + ` or you can do ` + "`" + `${client.Prefix}search ${args.join(" ")}` + "`" + `? But if you really want this command you can ` + "`" + `${client.Prefix}improve (what to improve)` + "`",
                            thumbnail: "",
                            fields: [],
                            image: {
                                url: "",
                    ...
                    client.request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&limit=1000/index.php?page=dapi&s=post&q=index&tags=${client.banlist}${client.banlist}-loli -asian -3d -photo_(medium) ${types[1]} ${args.join(" ")}&json=1`).then(res => res.text()).then(body => {
                        if (body.trim() !== "") {
                            var shouldIReturn = false;
                            if (!body) {
                                const Embed = {
                    ...
                    if (message.channel.nsfw === true || message.guild === null) {
                        client.request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&limit=1000/index.php?page=dapi&s=post&q=index&tags=${client.banlist}${client.banlist}-loli -asian -3d -photo_(medium) ${args.join(" ")}&json=1`).then(res => res.text()).then(body => {
                            if (body.trim() !== "") {
                                var shouldIReturn = false;
                                if (!body) {
                                    const Embed = {
