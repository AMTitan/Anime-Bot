module.exports = function(message, commandName, args, client) {
    if (message.channel.nsfw === true || message.guild === null) {
        client.request(`https://akaneko-api.herokuapp.com/api/zettai-ryouiki`).then(res => res.text()).then(body => {
            if (body.trim() !== "") {
...
module.exports.config = {
    description: "Gives you a zettai ryouiki image",
    usage: `zettairyouiki`,
    aliases: ["zettai-ryouiki"],
    type: "nsfw",
    optinal: ""
}