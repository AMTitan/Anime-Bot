...
client.on('message', (message) => {
	...
	} else if (commandName.toLowerCase() === 'fox') {
		if (args[0] && args[0].toLowerCase() === "nsfw") {
			if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'gif') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/gif`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'uniform') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/uniform`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'school') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/school`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'femdom') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/femdom`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'panties') {
		if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'maid') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/maid`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'ass') {
		if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'cumslut') {
		if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'bdsm') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/bdsm`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'orgy') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/orgy`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'feet') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/feet`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'glasses') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/glasses`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'thighs') {
		if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'tentacle') {
		if (message.channel.nsfw === true || message.guild === null) {
	...
	} else if (commandName.toLowerCase() === 'masturbation') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/masturbation`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
	...
	} else if (commandName.toLowerCase() === 'yuri') {
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://akaneko-api.herokuapp.com/api/yuri`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					var jsonParsed = JSON.parse(body);
					const Embed = {
						color: '#00ff00',
		...
		if (message.channel.nsfw === true || message.guild === null) {
			request(`https://gelbooru.com/index.php?page=dapi&s=post&q=index&tags=${args[0]}&json=1`, function(error, response, body) {
				if (!error && response.statusCode == 200) {
					...
					console.log(jsonParsed.file_url);
					const Embed = {
						color: '#00ff00',
						title: `${args[0]}`,
						url: "",
